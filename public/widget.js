(function () {
  ...
  // Height calculation: button (56px) + button bottom (20px) + gap (14px) + container (500px) + top margin (30px) = 620px
  const OPEN_HEIGHT = 620; // Ensures container sits above button with proper spacing
